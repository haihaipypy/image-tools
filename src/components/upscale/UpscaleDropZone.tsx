...
/**
 * 放大工具的拖拽区：一次只收一张图，因为推理是逐张跑的。
 */
export function UpscaleDropZone({ onFile, disabled = false }: UpscaleDropZoneProps) {
  ...
  return (
    ...
    >
      ...
      <div className="space-y-1">
        ...
        <p className="text-sm text-neutral-500 dark:text-neutral-400">{t.upscaleDropSubtitle}</p>
      </div>
      <input
        ref={inputRef}
        type="file"
